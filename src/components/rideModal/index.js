...
const RideModal = ({ isOpen, onRequestClose }) => {
  ...
  return (
    <Modal
      ...
      style={modalStyles}
    >
      <div onClick={onRequestClose}><FontAwesomeIcon icon={faArrowLeft}/></div>
      <h2 style={modalStyles.heading}>Carbon Footprint</h2>
      <p style={modalStyles.paragraph}>With this trip you will save</p>
      <div style={{ display: 'flex', alignItems: 'baseline', paddingBottom: '10px', borderBottom: '1px solid #ffffff33', marginBottom: '10px' }}>
      ...
      <div style={modalStyles.card}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <p style={{ color: '#ffffff80', fontWeight: 400, fontSize: '14px'}}>You will save 14.5kg</p>
        </div>
      </div>
      <div style={modalStyles.card}>
